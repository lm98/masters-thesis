...
%The package \textit{lang} contains the implementation of the core language constructs, that directly utilizes the \textit{RoundVM} defined in the \textit{round_vm} package alongside other related concepts such as context, export, path and slot. Finally, the \textit{execution} package contains functions to evaluate aggregate programs.